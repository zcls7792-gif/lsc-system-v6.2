...
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 80ms | -ms | 0ms | 0ms | 0 | 130ms |
| 商家管理后台 | **100** | 100 | - | - | 56ms | -ms | 0ms | 0ms | 0 | 95ms |
| 移动端 APP | **100** | 100 | - | - | 92ms | -ms | 0ms | 0ms | 0 | 89ms |
| 微信小程序 | **100** | 100 | - | - | 76ms | -ms | 0ms | 0ms | 0 | 67ms |
