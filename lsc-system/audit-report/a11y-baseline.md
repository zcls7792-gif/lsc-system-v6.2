...
> 生成于 **2026-08-29T15:54:12.206Z** · axe-core wcag2a+wcag2aa+best-practice · 4 应用 × 2 视口 × 2 色方案 = 共 16 项快照

## 汇总表

| # | 应用 | 视口 | 配色 | 加载 | 违规(V) | 待核查(Inc) | 通过规则 | console.error | console.warn | 4xx/5xx | 无 alt 图 | 正文长度 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | 平台管理后台 | 768×1024 | ☀️ light | ✅ | 0 | 1 | 40 | 0 | 0 | 0 | 0 | 1727 |
| 2 | 平台管理后台 | 768×1024 | 🌙 dark | ✅ | 0 | 1 | 40 | 0 | 0 | 0 | 0 | 1759 |
| 3 | 平台管理后台 | 1440×900 | ☀️ light | ✅ | 0 | 1 | 40 | 0 | 0 | 0 | 0 | 1866 |
| 4 | 平台管理后台 | 1440×900 | 🌙 dark | ✅ | 0 | 1 | 40 | 0 | 0 | 0 | 0 | 1872 |
| 5 | 商家管理后台 | 768×1024 | ☀️ light | ✅ | 0 | 1 | 42 | 0 | 0 | 0 | 0 | 954 |
| 6 | 商家管理后台 | 768×1024 | 🌙 dark | ✅ | 0 | 1 | 42 | 0 | 0 | 0 | 0 | 953 |
| 7 | 商家管理后台 | 1440×900 | ☀️ light | ✅ | 0 | 1 | 42 | 0 | 0 | 0 | 0 | 1105 |
| 8 | 商家管理后台 | 1440×900 | 🌙 dark | ✅ | 0 | 1 | 42 | 0 | 0 | 0 | 0 | 1105 |
| 9 | 移动端 APP | 360×740 | ☀️ light | ✅ | 0 | 1 | 32 | 0 | 0 | 0 | 0 | 366 |
| 10 | 移动端 APP | 360×740 | 🌙 dark | ✅ | 0 | 1 | 32 | 0 | 0 | 0 | 0 | 366 |
| 11 | 移动端 APP | 768×1024 | ☀️ light | ✅ | 0 | 1 | 32 | 0 | 0 | 0 | 0 | 366 |
| 12 | 移动端 APP | 768×1024 | 🌙 dark | ✅ | 0 | 1 | 32 | 0 | 0 | 0 | 0 | 366 |
| 13 | 微信小程序 | 360×740 | ☀️ light | ✅ | 0 | 1 | 34 | 0 | 0 | 0 | 0 | 422 |
| 14 | 微信小程序 | 360×740 | 🌙 dark | ✅ | 0 | 1 | 34 | 0 | 0 | 0 | 0 | 422 |
| 15 | 微信小程序 | 768×1024 | ☀️ light | ✅ | 0 | 1 | 34 | 0 | 0 | 0 | 0 | 422 |
| 16 | 微信小程序 | 768×1024 | 🌙 dark | ✅ | 0 | 1 | 34 | 0 | 0 | 0 | 0 | 422 |
| — | **合计 16** | — | light(0)/dark(0) | — | **0** | — | — | **0** | **0** | **0** | **0** | — |

> 子统计: Light 模式违规=0  通过规则=296   Dark 模式违规=0  通过规则=296

## 逐项违规详情

### 平台管理后台 · 平板 768×1024 (iPad mini) (768×1024) ☀️light  
- 加载: ✅    截图: ![platform-md-light](audit-report/platform__md__768x1024.png)  
- URL: `http://127.0.0.1:44933/platform-admin/index.html`   配色: `light`
...
- URL: `http://127.0.0.1:44933/platform-admin/index.html`   配色: `dark`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)
...
- URL: `http://127.0.0.1:44933/merchant-admin/index.html`   配色: `light`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)

### 商家管理后台 · 平板 768×1024 (iPad mini) (768×1024) 🌙dark  
- 加载: ✅    截图: ![merchant-md-dark](audit-report/merchant__md__768x1024__dark.png)  
- URL: `http://127.0.0.1:44933/merchant-admin/index.html`   配色: `dark`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)
...
- URL: `http://127.0.0.1:44933/mobile-app/index.html`   配色: `light`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)

### 移动端 APP · 移动端 360×740 (iPhone SE) (360×740) 🌙dark  
- 加载: ✅    截图: ![mobile-sm-dark](audit-report/mobile__sm__360x740__dark.png)  
- URL: `http://127.0.0.1:44933/mobile-app/index.html`   配色: `dark`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)
...
- URL: `http://127.0.0.1:44933/mini-program/index.html`   配色: `light`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)

### 微信小程序 · 移动端 360×740 (iPhone SE) (360×740) 🌙dark  
- 加载: ✅    截图: ![mini-sm-dark](audit-report/mini__sm__360x740__dark.png)  
- URL: `http://127.0.0.1:44933/mini-program/index.html`   配色: `dark`
- 违规: ✅ 0 项 (axe wcag2a / 2aa / best-practice)
...
- Light 模式: 违规 0 / 通过规则 296    Dark 模式: 违规 0 / 通过规则 296
