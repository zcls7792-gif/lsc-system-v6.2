...
- 生成时间: 2026-08-31T04:16:05.327Z
- 形态: **移动端 (iPhone 390×844)**
- 核心汇总: 平均 Perf=100 · 平均 A11y=100 · 最大 LCP=0ms · 最大 TBT=0ms · 最大 CLS=0.0001

## 4 应用分数矩阵

| 应用 | Perf | A11y | BP | SEO | FCP | SI | LCP | TBT | CLS | TTI |
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 68ms | -ms | 0ms | 0ms | 0.0001 | 143ms |
| 商家管理后台 | **100** | 100 | - | - | 60ms | -ms | 0ms | 0ms | 0 | 89ms |
| 移动端 APP | **100** | 100 | - | - | 56ms | -ms | 0ms | 0ms | 0 | 77ms |
| 微信小程序 | **100** | 100 | - | - | 56ms | -ms | 0ms | 0ms | 0 | 73ms |
