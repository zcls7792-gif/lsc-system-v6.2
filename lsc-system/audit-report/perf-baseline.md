...
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 136ms | -ms | 0ms | 0ms | 0 | 187ms |
| 商家管理后台 | **100** | 100 | - | - | 72ms | -ms | 0ms | 0ms | 0 | 91ms |
| 移动端 APP | **100** | 100 | - | - | 88ms | -ms | 0ms | 0ms | 0 | 86ms |
| 微信小程序 | **100** | 100 | - | - | 116ms | -ms | 0ms | 0ms | 0 | 69ms |
