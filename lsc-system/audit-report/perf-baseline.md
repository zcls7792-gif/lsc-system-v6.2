...
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 228ms | -ms | 0ms | 0ms | 0 | 183ms |
| 商家管理后台 | **100** | 100 | - | - | 132ms | -ms | 0ms | 0ms | 0 | 61ms |
| 移动端 APP | **100** | 100 | - | - | 88ms | -ms | 0ms | 0ms | 0 | 87ms |
| 微信小程序 | **100** | 100 | - | - | 76ms | -ms | 0ms | 0ms | 0 | 79ms |
