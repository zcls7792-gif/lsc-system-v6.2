...
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 244ms | -ms | 0ms | 0ms | 0 | 137ms |
| 商家管理后台 | **100** | 100 | - | - | 64ms | -ms | 0ms | 0ms | 0 | 110ms |
| 移动端 APP | **100** | 100 | - | - | 128ms | -ms | 0ms | 0ms | 0 | 95ms |
| 微信小程序 | **100** | 100 | - | - | 64ms | -ms | 0ms | 0ms | 0 | 90ms |
