...
|---|---|---|---|---|---|---|---|---|---|---|
| 平台管理后台 | **100** | 100 | - | - | 128ms | -ms | 0ms | 0ms | 0 | 175ms |
| 商家管理后台 | **100** | 100 | - | - | 104ms | -ms | 0ms | 0ms | 0 | 78ms |
| 移动端 APP | **100** | 100 | - | - | 96ms | -ms | 0ms | 0ms | 0 | 69ms |
| 微信小程序 | **100** | 100 | - | - | 96ms | -ms | 0ms | 0ms | 0 | 66ms |
